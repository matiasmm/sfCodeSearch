...
class appDevDebugProjectContainer extends Container implements TaggedContainerInterface
{
    ...
    protected function getRouting_Loader_RealService()
    {
        ...
        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader(array('Application' => '/home/matias/workspace/sfCodeSearh/app/../src/Application', 'Bundle' => '/home/matias/workspace/sfCodeSearh/app/../src/Bundle', 'Symfony\\Bundle' => '/home/matias/workspace/sfCodeSearh/app/../src/vendor/symfony/src/Symfony/Bundle')));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader(array('Application' => '/home/matias/workspace/sfCodeSearh/app/../src/Application', 'Bundle' => '/home/matias/workspace/sfCodeSearh/app/../src/Bundle', 'Symfony\\Bundle' => '/home/matias/workspace/sfCodeSearh/app/../src/vendor/symfony/src/Symfony/Bundle')));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader(array('Application' => '/home/matias/workspace/sfCodeSearh/app/../src/Application', 'Bundle' => '/home/matias/workspace/sfCodeSearh/app/../src/Bundle', 'Symfony\\Bundle' => '/home/matias/workspace/sfCodeSearh/app/../src/vendor/symfony/src/Symfony/Bundle')));
    ...
    {
        return $this->services['router'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), '/home/matias/workspace/sfCodeSearh/app/config/routing_dev.yml', array('cache_dir' => '/home/matias/workspace/sfCodeSearh/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'app_devUrlGenerator', 'matcher_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_base_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'app_devUrlMatcher'));
    }
    ...
    {
        return $this->services['validator'] = new \Symfony\Component\Validator\Validator(new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader(array('validation' => 'Symfony\\Component\\Validator\\Constraints\\')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader('loadValidatorMetadata'), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/matias/workspace/sfCodeSearh/src/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/DependencyInjection/../../../Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array())))), new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array()));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/matias/workspace/sfCodeSearh/app');
    }
    ...
    {
        $this->services['translator.real'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => '/home/matias/workspace/sfCodeSearh/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['translator'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => '/home/matias/workspace/sfCodeSearh/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SQLiteProfilerStorage('/home/matias/workspace/sfCodeSearh/app/cache/dev/profiler.db', 86400), $this->get('logger'));
        ...
        $instance->add($this->get('doctrine.odm.mongodb.data_collector'));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('charset' => 'UTF-8', 'debug' => true, 'cache' => '/home/matias/workspace/sfCodeSearh/app/cache/dev/twig', 'strict_variables' => true));
    ...
    {
        return $this->services['twig.loader'] = new \Symfony\Bundle\TwigBundle\Loader\FilesystemLoader($this->get('templating.name_parser'), array(0 => '/home/matias/workspace/sfCodeSearh/app/views/%bundle%/%controller%/%name%.%renderer%.%format%', 1 => '/home/matias/workspace/sfCodeSearh/app/../src/Application/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%', 2 => '/home/matias/workspace/sfCodeSearh/app/../src/Bundle/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%', 3 => '/home/matias/workspace/sfCodeSearh/app/../src/vendor/symfony/src/Symfony/Bundle/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%'), $this->get('logger'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Bundle\DoctrineMongoDBBundle\DataCollector\DoctrineMongoDBDataCollector A Symfony\Bundle\DoctrineMongoDBBundle\DataCollector\DoctrineMongoDBDataCollector instance.
     */
    ...
    protected function getDoctrine_Odm_Mongodb_DefaultConfigurationService()
    {
        ...
        $a->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($this->get('doctrine.odm.mongodb.metadata.annotation_reader'), array(0 => '/home/matias/workspace/sfCodeSearh/src/Application/IndexBundle/Document')), 'Application\\IndexBundle\\Document');

        $this->services['doctrine.odm.mongodb.default_configuration'] = $instance = new \Doctrine\ODM\MongoDB\Configuration();

        $instance->setDocumentNamespaces(array('IndexBundle' => 'Application\\IndexBundle\\Document'));
        $instance->setMetadataCacheImpl($this->get('doctrine.odm.mongodb.default_metadata_cache'));
        $instance->setMetadataDriverImpl($a);
        $instance->setProxyDir('/home/matias/workspace/sfCodeSearh/app/cache/dev/doctrine/odm/mongodb/Proxies');
        $instance->setProxyNamespace('Proxies');
        $instance->setAutoGenerateProxyClasses(false);
        $instance->setHydratorDir('/home/matias/workspace/sfCodeSearh/app/cache/dev/doctrine/odm/mongodb/Hydrators');
        $instance->setHydratorNamespace('Proxies');
        $instance->setAutoGenerateHydratorClasses(false);
        $instance->setDefaultDB('index_dev');
    ...
    protected function getLoggerService()
    {
        ...
        $b = new \Zend\Log\Writer\Stream('/home/matias/workspace/sfCodeSearh/app/logs/dev.log');
        $b->addFilter($a);
...
'));
    ...
    public function findTaggedServiceIds($name)
    {
        static $tags = array(
            ...
            'doctrine.odm.mongodb.event_manager' => array(
                'doctrine.odm.mongodb.event_manager' => array(
                    0 => array(
    ...
    {
        return array(
            'kernel.root_dir' => '/home/matias/workspace/sfCodeSearh/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/matias/workspace/sfCodeSearh/app/cache/dev',
            'kernel.logs_dir' => '/home/matias/workspace/sfCodeSearh/app/logs',
            'kernel.bundle_dirs' => array(
                'Application' => '/home/matias/workspace/sfCodeSearh/app/../src/Application',
                'Bundle' => '/home/matias/workspace/sfCodeSearh/app/../src/Bundle',
                'Symfony\\Bundle' => '/home/matias/workspace/sfCodeSearh/app/../src/vendor/symfony/src/Symfony/Bundle',
            ),
            'kernel.bundles' => array(
                ...
                7 => 'Application\\IndexBundle\\IndexBundle',
                8 => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle',
            ),
            ...
            'routing.resource' => '/home/matias/workspace/sfCodeSearh/app/config/routing_dev.yml',
            ...
            'templating.loader.filesystem.path' => array(
                0 => '/home/matias/workspace/sfCodeSearh/app/views/%bundle%/%controller%/%name%.%renderer%.%format%',
                1 => '/home/matias/workspace/sfCodeSearh/app/../src/Application/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%',
                2 => '/home/matias/workspace/sfCodeSearh/app/../src/Bundle/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%',
                3 => '/home/matias/workspace/sfCodeSearh/app/../src/vendor/symfony/src/Symfony/Bundle/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%',
            ),
            ...
            'translation.resources' => array(
                0 => array(
                    0 => 'xliff',
                    1 => '/home/matias/workspace/sfCodeSearh/src/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/translations/validators.fr.xliff',
                    2 => 'fr',
                    3 => 'validators',
                ),
            ),
            ...
            'profiler.storage.file' => '/home/matias/workspace/sfCodeSearh/app/cache/dev/profiler.db',
            ...
            'twig.options' => array(
                'charset' => 'UTF-8',
                'debug' => true,
                'cache' => '/home/matias/workspace/sfCodeSearh/app/cache/dev/twig',
            ...
            'doctrine.odm.mongodb.default_database' => 'index_dev',
            ...
            'doctrine.odm.mongodb.proxy_dir' => '/home/matias/workspace/sfCodeSearh/app/cache/dev/doctrine/odm/mongodb/Proxies',
            'doctrine.odm.mongodb.auto_generate_proxy_classes' => false,
            'doctrine.odm.mongodb.hydrator_namespace' => 'Proxies',
            'doctrine.odm.mongodb.hydrator_dir' => '/home/matias/workspace/sfCodeSearh/app/cache/dev/doctrine/odm/mongodb/Hydrators',
...
',
            'zend.logger.path' => '/home/matias/workspace/sfCodeSearh/app/logs/dev.log',
